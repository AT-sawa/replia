      ...
      {imageDataUrl && (
        <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
          <button
            ...
            onClick={() => cameraRef.current?.click()}
            style={{
              flex: 1, height: 26, background: 'transparent', color: '#059669',
              border: '1px solid #D1FAE5', borderRadius: 100, fontSize: 10,
              cursor: 'pointer',
            }}
          >
            撮り直す
          ...
          <button
            ...
            style={{
              flex: 1, height: 26, background: 'transparent', color: '#98A2AE',
              border: '1px solid #E8ECF0', borderRadius: 100, fontSize: 10,
              cursor: 'pointer',
            }}
          >
            削除
